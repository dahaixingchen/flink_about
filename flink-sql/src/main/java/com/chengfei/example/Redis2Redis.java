...
public class Redis2Redis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table selTab = tabEnv.sqlQuery("select sys_date from TblKmTrace ");
...
//        System.out.println(accumulatorResultNum);
        System.out.println((int) (jobResult.getAccumulatorResult("totalDataSize")));
